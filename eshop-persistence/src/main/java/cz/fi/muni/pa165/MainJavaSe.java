...
public class MainJavaSe {
	...
	private static void task06() {
		...
		//Calendar calendarDateAdded = new GregorianCalendar(2011, Calendar.JANUARY,20);
		guitar.setAddedDate(LocalDate.of(2011, Month.JANUARY, 20));
